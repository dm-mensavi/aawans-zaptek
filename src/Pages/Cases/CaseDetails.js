	...
	return (
		<div>
			...
			<div className="flex flex-col items-center my-20">
				<div  className="sm:relative  pr-10 pl-10">
				<div>
				<img
					src={caseItem.image}
					alt="not found"
				...
				<div className="lg:h-28 lg:w-96 bg-primary rounded-2xl w-58 mt-10 sm:pt-0 sm:absolute sm:bottom-8 sm:right-14 lg:right-20">
